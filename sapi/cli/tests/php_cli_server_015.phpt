...
<br />
<b>Fatal error</b>:  Uncaught exception 'EngineException' with message 'Call to undefined function non_exists_function()' in %s:%d
Stack trace:
#0 %s(%d): require()
#1 {main}
  thrown in <b>%ssyntax_error.php</b> on line <b>%s</b><br />
