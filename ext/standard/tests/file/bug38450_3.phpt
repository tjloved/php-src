...
Fatal error: Uncaught exception 'EngineException' with message 'Argument 1 passed to VariableStream::__construct() must be of the type array, none given' in %s:%d
Stack trace:
