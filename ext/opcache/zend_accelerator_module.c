...
ZEND_INI_BEGIN()
	...
	STD_PHP_INI_ENTRY("opcache.ssa_debug_level"       , "0"      , PHP_INI_SYSTEM, OnUpdateLong,             accel_directives.ssa_debug_level,            zend_accel_globals, accel_globals)
	STD_PHP_INI_ENTRY("opcache.ssa_opt_level"       , "-1"      , PHP_INI_SYSTEM, OnUpdateLong,             accel_directives.ssa_opt_level,            zend_accel_globals, accel_globals)
	STD_PHP_INI_ENTRY("opcache.ssa_debug_func"        , ""       , PHP_INI_SYSTEM, OnUpdateString,           accel_directives.ssa_debug_func,             zend_accel_globals, accel_globals)
	STD_PHP_INI_ENTRY("opcache.opt_statistics"        , "0"      , PHP_INI_SYSTEM, OnUpdateBool,             accel_directives.opt_statistics,             zend_accel_globals, accel_globals)
