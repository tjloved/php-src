...
static inline void foreach_op_array(
		zend_optimizer_ctx *ctx, void fn(zend_op_array *op_array, zend_optimizer_ctx *ctx))
{
	zend_script *script = ctx->script;
	zend_op_array *op_array;
	zend_class_entry *ce;
	zend_string *name;

	fn(&script->main_op_array, ctx);
