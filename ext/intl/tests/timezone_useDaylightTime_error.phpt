...
Fatal error: Uncaught exception 'EngineException' with message 'Argument 1 passed to intltz_use_daylight_time() must be an instance of IntlTimeZone, null given' in %s:%d
Stack trace:
