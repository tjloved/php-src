...
try { var_dump(intlcal_get_least_maximum(1, 1)); }
catch (Exception $e) { echo get_class($e), ': ', $e->getMessage(), "\n"; }
try { var_dump(intlcal_get_maximum(1, 1)); }
catch (Exception $e) { echo get_class($e), ': ', $e->getMessage(), "\n"; }
try { var_dump(intlcal_get_greatest_minimum(1, -1)); }
catch (Exception $e) { echo get_class($e), ': ', $e->getMessage(), "\n"; }
try { var_dump(intlcal_get_minimum(1, -1)); }
catch (Exception $e) { echo get_class($e), ': ', $e->getMessage(), "\n"; }
...
bool(false)
EngineException: Argument 1 passed to intlcal_get_least_maximum() must be an instance of IntlCalendar, integer given
EngineException: Argument 1 passed to intlcal_get_maximum() must be an instance of IntlCalendar, integer given
EngineException: Argument 1 passed to intlcal_get_greatest_minimum() must be an instance of IntlCalendar, integer given
EngineException: Argument 1 passed to intlcal_get_minimum() must be an instance of IntlCalendar, integer given
