...
Fatal error: Uncaught exception 'EngineException' with message 'Argument 1 passed to transliterator_create_inverse() must be an instance of Transliterator, string given' in %s:%d
Stack trace:
