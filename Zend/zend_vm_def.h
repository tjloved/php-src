...
ZEND_VM_HANDLER(200, ZEND_ADD_INT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST))
{
	USE_OPLINE
...
ZEND_VM_HANDLER(201, ZEND_SUB_INT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HANDLER(202, ZEND_ADD_FLOAT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HANDLER(203, ZEND_SUB_FLOAT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HANDLER(204, ZEND_MUL_FLOAT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HANDLER(196, ZEND_DIV_FLOAT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HANDLER(191, ZEND_IS_SMALLER_FLOAT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST,SMART_BRANCH))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HANDLER(192, ZEND_IS_SMALLER_INT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST,SMART_BRANCH))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HANDLER(193, ZEND_ADD_INT_NO_OVERFLOW, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HANDLER(211, ZEND_PRE_INC_INT, TMPVARCV, ANY)
{
	USE_OPLINE
...
ZEND_VM_HANDLER(212, ZEND_PRE_INC_INT_NO_OVERFLOW, TMPVARCV, ANY)
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_PTR_UNDEF(BP_VAR_RW);
	Z_LVAL_P(op1)++;
...
ZEND_VM_HANDLER(213, ZEND_PRE_DEC_INT, TMPVARCV, ANY)
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_PTR_UNDEF(BP_VAR_RW);
...
ZEND_VM_HANDLER(207, ZEND_POST_INC_INT, TMPVARCV, ANY)
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_PTR_UNDEF(BP_VAR_RW);
	ZVAL_COPY_VALUE(EX_VAR(opline->result.var), op1);
...
ZEND_VM_HANDLER(208, ZEND_POST_DEC_INT, TMPVARCV, ANY)
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_PTR_UNDEF(BP_VAR_RW);
	ZVAL_COPY_VALUE(EX_VAR(opline->result.var), op1);
...
ZEND_VM_HANDLER(194, ZEND_FETCH_DIM_INT, TMPVAR|CV, CONST|TMPVARCV)
{
	USE_OPLINE
	zend_free_op free_op1;
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HANDLER(197, ZEND_ENSURE_HAVE_THIS, ANY, ANY)
{
	USE_OPLINE
