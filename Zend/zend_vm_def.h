...
ZEND_VM_HOT_HANDLER(200, ZEND_ADD_INT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST))
{
	USE_OPLINE
...
ZEND_VM_HOT_HANDLER(201, ZEND_SUB_INT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HOT_HANDLER(202, ZEND_ADD_FLOAT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HOT_HANDLER(203, ZEND_SUB_FLOAT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HOT_HANDLER(204, ZEND_MUL_FLOAT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HOT_HANDLER(205, ZEND_DIV_FLOAT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HOT_HANDLER(206, ZEND_IS_SMALLER_FLOAT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST,SMART_BRANCH))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
	int result = Z_DVAL_P(op1) < Z_DVAL_P(op2);
	ZEND_VM_SMART_BRANCH(result, 0);
	ZVAL_BOOL(EX_VAR(opline->result.var), result);
	ZEND_VM_NEXT_OPCODE();
}

ZEND_VM_HOT_HANDLER(207, ZEND_IS_SMALLER_INT, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST,SMART_BRANCH))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HOT_HANDLER(208, ZEND_ADD_INT_NO_OVERFLOW, CONST|TMPVARCV, CONST|TMPVARCV, SPEC(NO_CONST_CONST))
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	zval *op2 = GET_OP2_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HOT_HANDLER(209, ZEND_PRE_INC_INT, TMPVARCV, ANY)
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_PTR_UNDEF(BP_VAR_RW);
	fast_long_increment_function(op1);
	ZEND_VM_NEXT_OPCODE();
}

ZEND_VM_HOT_HANDLER(210, ZEND_PRE_INC_INT_NO_OVERFLOW, TMPVARCV, ANY)
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_PTR_UNDEF(BP_VAR_RW);
	Z_LVAL_P(op1)++;
...
ZEND_VM_HOT_HANDLER(211, ZEND_PRE_DEC_INT, TMPVARCV, ANY)
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_PTR_UNDEF(BP_VAR_RW);
...
ZEND_VM_HOT_HANDLER(212, ZEND_POST_INC_INT, TMPVARCV, ANY)
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_PTR_UNDEF(BP_VAR_RW);
	ZVAL_COPY_VALUE(EX_VAR(opline->result.var), op1);
...
ZEND_VM_HOT_HANDLER(213, ZEND_POST_DEC_INT, TMPVARCV, ANY)
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_PTR_UNDEF(BP_VAR_RW);
	ZVAL_COPY_VALUE(EX_VAR(opline->result.var), op1);
...
ZEND_VM_HANDLER(214, ZEND_FETCH_DIM_INT, TMPVAR|CV, CONST|TMPVARCV)
{
	USE_OPLINE
	zend_free_op free_op1;
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
...
ZEND_VM_HANDLER(215, ZEND_FETCH_DIM_INT_W, CV, CONST|TMPVARCV)
{
	USE_OPLINE
	zend_free_op free_op1;
...
ZEND_VM_HOT_HANDLER(216, ZEND_MOV_UNCOUNTED, CONST|TMPVARCV, ANY)
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
	ZVAL_COPY_VALUE(EX_VAR(opline->result.var), op1);
...
ZEND_VM_HOT_HANDLER(217, ZEND_FETCH_OBJ_R_FIXED, TMPVAR|UNUSED|THIS|CV, CONST, NUM)
{
	USE_OPLINE
	zend_free_op free_op1;
	zval *retval;
...
ZEND_VM_HANDLER(218, ZEND_PHI_ASSIGN, CV, CV)
{
...
ZEND_VM_HANDLER(219, ZEND_ENSURE_HAVE_THIS, ANY, ANY)
{
	USE_OPLINE
	if (UNEXPECTED(Z_TYPE(EX(This)) == IS_UNDEF)) {
		SAVE_OPLINE();
		zend_throw_error(NULL, "Using $this when not in object context");
		HANDLE_EXCEPTION();
	}
...
ZEND_VM_HOT_HANDLER(220, ZEND_RECV_INIT_FAST, NUM, CONST)
{
	USE_OPLINE
	uint32_t arg_num;
	zval *param;
...
ZEND_VM_HOT_HANDLER(221, ZEND_SEND_VAR_FAST, VAR|CV, NUM)
{
	USE_OPLINE
	zval *varptr, *arg;
	zend_free_op free_op1;
...
ZEND_VM_HANDLER(222, ZEND_ASSERT_TYPE, TMPVARCV, ANY)
{
	USE_OPLINE
	zval *op1 = GET_OP1_ZVAL_PTR_UNDEF(BP_VAR_R);
