...
Fatal error: Uncaught exception 'EngineException' with message 'Argument 1 passed to test() must be an instance of Closure, instance of stdClass given, called in %s on line %d and defined' in %s:%d
Stack trace:
