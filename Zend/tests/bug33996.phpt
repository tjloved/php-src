...
Hi!
Fatal error: Uncaught exception 'EngineException' with message 'Argument 1 passed to FooTest() must be an instance of Foo, none given, called in %s on line %d and defined' in %s:%d
Stack trace:
#0 %s(%d): FooTest()
#1 {main}
