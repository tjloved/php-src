...
function fn1721260272()
{
    # This test validates that autoloading works for common const expression (AST) use cases
    $classlist = ['A' => 'class A { const HW = "this is A"; }', 'B' => 'class B extends A { const HW = parent::HW." extended by B"; }', 'space1\\C' => 'namespace space1; class C { const HW = "this is space1\\C"; }', 'D' => 'class D  { const HW = \\space1\\C::HW." extented by D"; }', 'trE' => 'trait trE { public static function getHW() { return parent::HW; } }', 'E' => 'class E extends B { use trE; }', 'F' => 'class F { const XX = "this is F"; }', 'G' => 'class G extends F { const XX = parent::XX." extended by G"; public static function get_me($x = "got ".self::XX) { return $x; } }'];
