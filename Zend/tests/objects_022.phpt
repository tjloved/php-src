...
Fatal error: Uncaught exception 'EngineException' with message 'Argument 1 passed to foo::testFoo() must be an instance of foo, instance of stdClass given, called in %s on line %d and defined' in %s:%d
Stack trace:
