...
function fn1565894255()
{
    /* Format: [Function, [Obj, Scope]] */
    $tests = [['func', [[null, null], [new Cls(), null], [new Cls(), 'Cls'], [null, 'Cls'], [null, 'stdClass'], [new stdClass(), null]]], ['strlen', [[null, null], [new Cls(), null], [new Cls(), 'Cls'], [null, 'Cls'], [null, 'stdClass'], [new stdClass(), null]]], [['Cls', 'staticMethod'], [[null, 'Cls'], [new Cls(), null], [new Cls(), 'Cls'], [null, null], [null, 'ClsChild'], [null, 'ClsUnrelated']]], [[new Cls(), 'method'], [[null, 'Cls'], [new Cls(), 'Cls'], [new ClsChild(), 'Cls'], [new ClsUnrelated(), 'Cls'], [new Cls(), null], [new Cls(), 'ClsUnrelated'], [new Cls(), 'ClsChild']]], [[new DLL(), 'count'], [[new DLL(), DLL::class], [new SplStack(), DLL::class], [new ClsUnrelated(), DLL::class], [null, null], [null, DLL::class], [new DLL(), null], [new DLL(), ClsUnrelated::class]]], [function () {
    }, [[null, null], [new Cls(), null], [new Cls(), 'Cls'], [null, 'Cls'], [null, 'stdClass'], [new stdClass(), null]]]];
