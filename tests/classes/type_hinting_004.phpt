...
Argument 1 passed to f1() must be an instance of A, integer given
in f1;
Argument 1 passed to f2() must be an instance of A, integer given
in f2;
in f2;
in f2;
...
---> Type hints with callback static method:
Argument 1 passed to C::f1() must be an instance of A, integer given
in C::f1 (static);
Argument 1 passed to C::f2() must be an instance of A, integer given
in C::f2 (static);
in C::f2 (static);
in C::f2 (static);
...
---> Type hints with callback instance method:
Argument 1 passed to D::f1() must be an instance of A, integer given
in C::f1 (instance);
Argument 1 passed to D::f2() must be an instance of A, integer given
in C::f2 (instance);
in C::f2 (instance);
in C::f2 (instance);
